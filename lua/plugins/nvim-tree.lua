...
-- Modal file explorer - always opens as floating window (ORIGINAL APPROACH)
...
return {
    ...
    config = function()
        ...
        local function get_current_file()
            ...
            if file_path == "" or
               file_path:match("NvimTree_") or
               file_path:match("toggleterm") or
               file_path:match("dashboard") then
                return ""
            end
        ...
        -- Function to open nvim-tree as modal window with sync (ORIGINAL)
        ...
        require("nvim-tree").setup({
            ...
            on_attach = function(bufnr)
                ...
                -- Enter -> expand folder or open file in new tab (ORIGINAL LOGIC)
                vim.keymap.set("n", "<CR>", function()
                    ...
                    elseif node.type == "file" then
                        ...
                        if not found then
                            ...
                            if vim.bo[curbuf].filetype == "dashboard" or
                               (vim.fn.bufname(curbuf) == "" and not vim.bo[curbuf].modified) then
                ...
                vim.keymap.set("n", "P", api.tree.change_root_to_parent, {buffer = bufnr, desc = "Parent directory"})
        ...
        -- Global function for modal tree access (RESTORE ORIGINAL)
        ...
        vim.api.nvim_create_user_command("NvimTreeChangeRoot", pick_root_directory, {desc = "Change NvimTree root directory"})
    end
}